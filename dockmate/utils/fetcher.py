...
def fetch_pdb(pdb_id: str, save_dir: Union[str, Path] = ".") -> Path:
    """
    Downloads a .pdb file from the RCSB PDB database using a 4-character PDB ID.

    Args:
        pdb_id (str): The 4-character alphanumeric PDB ID (e.g., '1UBQ').
    ...
    save_path = Path(save_dir).resolve() / f"{pdb_id}.pdb"
